...
{
    public class BoardInitializer : System.Data.Entity.CreateDatabaseIfNotExists<BoardContext>
    {
        protected override void Seed(BoardContext context)
        {
            InitializeBoardForEF(context);
        }

        public static void InitializeBoardForEF(BoardContext context)
        {
            if (context.Programs.Count() == 0)
            {
                var programs = new List<Program>
                {
                    new Program { Name="FIMA", Description="Federal Insurance Mitigation Administration", IsActive=true }
                };
            ...
            if (context.Projects.Count() == 0)
            {
                ...
                {
                    new Project { ProgramId=1, Name="UCORT", Description="UCORT Project", IsActive=true }
                };
            ...
            if (context.BoardTasksComments.Count() == 0)
            {
